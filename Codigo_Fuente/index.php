...
<body class="login">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="signup" class="tab-pane">
                            ...
                            <form action="" method="POST" id="formAlumno">
                                <input type="text" placeholder="Rut" name="rut" class="form-control top" id="rut">
                                <input type="text" placeholder="Nombre" name="nombre" class="form-control middle" id="nombre">
                                <input type="text" placeholder="Apellido" name="apellido" class="form-control middle" id="apellido">
                                <input type="email" placeholder="ejemplo@dominio.com" name="correo" class="form-control middle" id="email">
                                <input type="text" placeholder="Telefono" name="telefono" class="form-control middle" id="telefono">
                                <input type="password" placeholder="Contraseña" name="contra" class="form-control middle" id="contraseña">
                                <input type="password" placeholder="Repetir Contraseña" name="re-contra" class="form-control bottom" id="contraseña2">
                                <input type="hidden" name="rol" value="alumno" id="rol">
    ...
    <script src="vistas/assets/js/alumno.js"></script>
